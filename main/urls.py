...
urlpatterns = [
    ...
    path("search/<str:area>/<str:city>/<str:neighborhood>/<str:street>/<str:room_number>/<str:min_price>/<str:max_price>/<str:sort_option>/", views.search_apartments, name="search_with_params"),
]
