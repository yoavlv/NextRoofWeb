...
def search_apartments(request):
    ...
    if request.method == 'GET':
        ...
        results_df = pd.read_csv('core/data/Predicted_DB.csv')
        results_df_len = results_df.shape[0]

        results_df[
            'Price_int'] = results_df['Predicted'] + results_df['Difference']
